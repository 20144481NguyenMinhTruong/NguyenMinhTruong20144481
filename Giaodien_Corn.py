...
root=Tk()
root.title("Phần mềm xác định sâu bệnh")
root.geometry("576x1024+700+10")

anh1=Image.open(r"caybap.jpg")
...
# Camera
    ...
    # Xu ly phim bam
        ...
        if k == ord('q'):  # Bam q de thoat
            ...
            isBgCaptured = 1
            cv2.putText(frame, "Background captured", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2,
                        (0, 0, 255), 10, lineType=cv2.LINE_AA)
            time.sleep(2)
            ...
            bgModel = None
            isBgCaptured = 0
            cv2.putText(frame, "Background reset", (20, 150), cv2.FONT_HERSHEY_SIMPLEX, 2,
                        (0, 0, 255),10,lineType=cv2.LINE_AA)
...
def thoat():
    root.destroy()
Bt1= Button(root,fg='black',bg='#ffe4e1',border=0 ,text='BẮT ĐẦU',width ='15',height='2',
    font =('Times New Roman',18,'bold'), cursor= "hand2",activeforeground='#d3d3d3',command=batdau).place(x=30,y=100)

Bt1= Button(root,fg='black',bg='#ffe4e1',border=0 ,text='THOÁT',width ='15',height='2',
